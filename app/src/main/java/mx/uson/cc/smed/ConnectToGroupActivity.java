...
public class ConnectToGroupActivity extends AppCompatActivity
        ...
        new AlertDialog.Builder(this).setView(v).setPositiveButton(R.string.sign_to_group,
                new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        Toast.makeText(ConnectToGroupActivity.this, R.string.signed_to_group, Toast.LENGTH_SHORT).show();
                        direct.sendInfo(ConnectToGroupActivity.this, myInfo);
                        ConnectToGroupActivity.this.inscrito = true;
    ...
    public static class PagerAdapter extends FragmentPagerAdapter {
        ...
        public PagerAdapter(ConnectToGroupActivity activity) {
    ...
    public static class StepFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
            ...
            final ConnectToGroupActivity activity = (ConnectToGroupActivity)getActivity();
            View v = null;
            switch(pos){
    ...
    public static class DeviceListFragment extends ListFragment {
        ConnectToGroupActivity activity;
        WiFiPeerListAdapter adapter;

        @Override
        public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
                                 Bundle savedInstanceState) {
            activity = (ConnectToGroupActivity)getActivity();
